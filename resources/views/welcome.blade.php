...
<head>
    ...
    @else
        <style>
            ...
            /* Additional modern background styles */
            .bg-modern-gradient {
                background: radial-gradient(circle at 10% 20%, rgba(255, 245, 240, 0.8) 0%, rgba(253, 253, 252, 1) 90%);
            }

            .dark .bg-modern-gradient {
                background: radial-gradient(circle at 10% 20%, rgba(20, 20, 18, 0.9) 0%, rgba(10, 10, 10, 1) 90%);
            }

            .pattern-dots {
                background-image: radial-gradient(circle, #1b1b18 0.8px, transparent 0.8px);
                background-size: 20px 20px;
            }

            .dark .pattern-dots {
                background-image: radial-gradient(circle, #a1a09a 0.8px, transparent 0.8px);
            }
        </style>
    @endif
</head>
...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col bg-modern-gradient pattern-dots">
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <h1 class="mb-1 font-medium text-xl">Bienvenido!</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">{{ config('app.name', 'Laravel') }} El viaje de
                    transformación digital de una empresa minera hacia el futuro
                </p>
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span class="relative py-1 bg-white dark:bg-[#161615]"><span
                                class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]"><span
                                    class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-1.5 h-1.5"></span></span></span>
                        <span>Lee la <a href="#" target="_blank"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ml-1"><span>Documentación</span><svg
                    ...
                    <li
                        ...
                        <span class="relative py-1 bg-white dark:bg-[#161615]"><span
                                class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]"><span
                                    class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-1.5 h-1.5"></span></span></span>
                        <span>Conoce más en <a href="#" target="_blank"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ml-1"><span>MineCore</span><svg
                                    width="10" height="11" viewBox="0 0 10 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="w-2.5 h-2.5">
                                    <path d="M7.70833 6.95834V2.79167H3.54167M2.5 8L7.5 3.00001" stroke="currentColor"
                                        stroke-linecap="square" />
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <!-- Button redirects to /admin -->
                        <a href="/admin"
                            class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal shadow-md transition-all duration-200 hover:shadow-lg">
                            Ir a la App
                        </a>
                    </li>
                </ul>
            </div>
            <!-- Right Side: Mining Flow Image - Versión optimizada -->
            <div
                ...
                <!-- Usando background-image para mejor control -->
                <div class="absolute inset-0 w-full h-full bg-cover bg-no-repeat transition-all duration-750"
                    style="background-image: url('{{ asset('images/mining_flow2.webp') }}'); background-position: center 25%;">
                </div>

                <!-- Overlay gradient for modern aesthetic -->
                <div
                    class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/5 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg pointer-events-none">
                </div>
                <div
